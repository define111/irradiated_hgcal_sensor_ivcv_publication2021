...
class ChannelCV(ChannelIV):
    def __init__(self, _type="sensors"):
        ...
        if _type == "sensors":
            ...
            # specify style
            self.update("3009", {"Color": ROOT.kCyan+1, "LineStyle": 2, "MarkerStyle": 23, "Label": "HD, 120 #mum, ~4.2E15 neq/cm^{2}", "Priority": 2})
            self.update("0541_04", {"Color": ROOT.kOrange+1, "LineStyle": 2, "MarkerStyle": 20  , "Label": "LD, 200 #mum, ~1.9E15 neq/cm^{2}", "Priority": 3})
            self.update("1013", {"Color": ROOT.kBlue+1, "LineStyle": 2, "MarkerStyle": 21, "Label": "LD, 300 #mum, ~0.8E15 neq/cm^{2}", "Priority": 5})

...
if UREF == -1:
    ...
    PAIRS = [["1002", "2002", "3002", "3009", "3010", "1013", "3008", "1003", "1003_xcheck"], ["1102", "2114", "3102", "3109", "3110", "1114", "3104", "1113", "3107"], ["2004", "5414", "54117"], ["1101", "2105", "1105", "1105_xcheck", "3101"]]  
else:
...
if UREF == 600:
    ...
    location_label_text.DrawText(0.23, 0.24, "Rd. 1 (CERN)")
    location_label_text.DrawText(0.25, 0.40, "Rd. 10 (CERN)")
    location_label_text.DrawText(0.35, 0.18, "Rd. 9 (TTU)")
    location_label_text.DrawText(0.44, 0.42, "Rd. 7 (TTU)")
    location_label_text.DrawText(0.44, 0.38, "New: Rd. 9 (CERN)")
    location_label_text.DrawText(0.49, 0.47, "Rd. 11 (CERN)")
    location_label_text.DrawText(0.57, 0.54, "Rd. 5 (CERN)")
    location_label_text.DrawText(0.65, 0.76, "Rd. 8 (CERN)")
    location_label_text.DrawText(0.78, 0.48, "Rd. 6 (TTU)")
    location_label_text.DrawText(0.84, 0.78, "Rd. 3 (CERN)")


#save pdf
canvas.Print(os.path.join(thisdir, "{}_internal.pdf".format(name)))
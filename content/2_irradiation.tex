...
A sketch of the beam port and a photo of its inside are shown in \ref{fig:Beamport_Schematic}a and b.
\begin{figure}
  \begin{center}
...
For this purpose, the rest of the delivery cylinder was filled with 15-\SI{18}{\kilo\gram} of dry ice (\ref{fig:Beamport_Schematic}d).

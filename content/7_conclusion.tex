...
For the planned CMS HGCAL upgrade, the findings in this work are encouraging as they demonstrate overall consistency with the expected radiation hardness of the prototype silicon sensors.
In particular, their leakage current densities are found to scale proportionally with the fluence, and independent on the properties of the tested production process variations.
...
Therefore, the results reported in this work may serve as reference for the expected electrical performance and degradation of HGCAL's silicon sensors towards the end of its lifetime at HL-LHC.